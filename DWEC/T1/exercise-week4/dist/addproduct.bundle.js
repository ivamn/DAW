...
/* harmony import */ var _product_class_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./product.class.js */ "./product.class.js");
...
async function getCategories() {
    let data = await _http_js__WEBPACK_IMPORTED_MODULE_1__.Http.get(_constants_js__WEBPACK_IMPORTED_MODULE_2__.SERVER + 'categories');
...
function submitForm(e) {
    ...
    if (!newProductForm.title.value || !newProductForm.price.value || !newProductForm.image.value || !newProductForm.description.value || newProductForm.category.value == 0) {
        ...
        let p = new _product_class_js__WEBPACK_IMPORTED_MODULE_0__.Product({
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./add-product.js","vendors","commons"]
/******/ 		];
...
/******/ })()
;
//# sourceMappingURL=addproduct.bundle.js.map