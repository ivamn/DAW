...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<img class=\"card-img-top\" src=\""
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"datePublished") || (depth0 != null ? lookupProperty(depth0,"datePublished") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"datePublished","hash":{},"data":data,"loc":{"start":{"line":6,"column":50},"end":{"line":6,"column":67}}}) : helper)))
    + "</div>\n        <div><button class=\"btn btn-danger\">Delete</button></div>\n    </div>\n</div>\n<div class=\"card-footer bg-transparent text-muted row\">\n    <div class=\"col\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"category") || (depth0 != null ? lookupProperty(depth0,"category") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"category","hash":{},"data":data,"loc":{"start":{"line":11,"column":21},"end":{"line":11,"column":33}}}) : helper)))
    + "</div>\n    <div class=\"col text-right\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"price") || (depth0 != null ? lookupProperty(depth0,"price") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"price","hash":{},"data":data,"loc":{"start":{"line":12,"column":32},"end":{"line":12,"column":41}}}) : helper)))
    + " €</div>\n</div>";
},"useData":true});
...
/* harmony import */ var _http_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./http.js */ "./http.js");
...
class Product {
    ...
    static getAll() {
        return _http_js__WEBPACK_IMPORTED_MODULE_2__.Http.get(_constants_js__WEBPACK_IMPORTED_MODULE_3__.SERVER + 'products');
    }

    post() {
        return _http_js__WEBPACK_IMPORTED_MODULE_2__.Http.post(_constants_js__WEBPACK_IMPORTED_MODULE_3__.SERVER + 'products', this);
    }

    delete() {
        return _http_js__WEBPACK_IMPORTED_MODULE_2__.Http.delete(_constants_js__WEBPACK_IMPORTED_MODULE_3__.SERVER + 'products/' + this.id);
    }
    ...
    toHTML() {
        ...
        p.datePublished = moment__WEBPACK_IMPORTED_MODULE_1__(p.datePublished).fromNow();
