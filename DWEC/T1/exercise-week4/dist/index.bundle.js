...
async function getProducts() {
    let resp = await _product_class_js__WEBPACK_IMPORTED_MODULE_0__.Product.getAll();
    for (const p of resp.products) {
        productsArray.push(new _product_class_js__WEBPACK_IMPORTED_MODULE_0__.Product(p));
    }
